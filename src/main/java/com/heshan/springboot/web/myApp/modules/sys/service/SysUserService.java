...
public interface SysUserService {
	 ...
	 * 保存用户
	 */
	PageResult save(SysUserEntity user);
	 ...
	 * 重置密码
	 * */
	void updatePass(SysUserEntity userEntity);

	void isNoUser(SysUserEntity user);

	void updateUser(SysUserEntity user);

	void saveOrUser(Long userId, List<Long> roleIdList);

	List<SysRoleEntity> OrUserList(Long userId);
